...
_E5_STYLE_SOFTMAX = CFG.DTYPE_QKV == 1 or (CFG.DTYPE_QKV == 0 and (CFG.MASK_FLAGS == MASK_NONE or (CFG.MASK_FLAGS == MASK_CAUSAL and CFG.BOTTOM_RIGHT == 0)))
...
_STAT_FULL_WARP_ARRIVALS = CFG.SOFTMAX_WARPGROUPS == 2 and CFG.MASK_FLAGS == MASK_CAUSAL and CFG.BOTTOM_RIGHT == 0
