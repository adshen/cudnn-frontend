...
def build_thd_meta_o_kv_descs_kernel(
    ...
    kv_seq_dim: cutlass.Constexpr[int] = 2,
) -> None:
    ...
    if nvvm.elect_sync():
        ...
        nvvm.tensormap_replace(nvvm.TensormapField.GLOBAL_DIM, k_dptr, new_value=t_kv, ord=kv_seq_dim)
        ...
        nvvm.tensormap_replace(nvvm.TensormapField.GLOBAL_DIM, v_dptr, new_value=t_kv, ord=kv_seq_dim)
