...
from cudnn.frost.gemm.kernel_registry import candidates as _registry_candidates
...
# nvfp4 packing/reorder helpers (matches test/python/frost/gemm/test_block_scale.py).
_E2M1 = [
    0.0,
    0.5,
    1.0,
