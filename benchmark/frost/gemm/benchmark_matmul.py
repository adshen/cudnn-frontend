...
hot-L2 inflation on small shapes.
    ...
    python benchmark/frost/gemm/benchmark_matmul.py --shape 1,8192,8192,8192
"""
...
from cudnn.frost.gemm.fusion_ir import FusionChain as _FC, MatmulSpec as _MS
from cudnn.frost.gemm.kernel_registry import candidates as _candidates
