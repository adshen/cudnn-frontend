# cudnn.TBD.gemm benchmarks

Performance measurement scripts for the cudnn.TBD.gemm GEMM kernels on sm100.
...
python benchmark/TBD/gemm/benchmark_matmul.py                              # default: 4096³, --timing delayed
python benchmark/TBD/gemm/benchmark_matmul.py --shape 8192,8192,8192
python benchmark/TBD/gemm/benchmark_matmul.py --shape 4096,11008,4096      # Llama-FFN up
python benchmark/TBD/gemm/benchmark_matmul.py --configs CONFIG_sm100_128x256x128_128x256x32_cluster2x1_2ctamma,CONFIG_sm100_128x256x128_128x256x32_cluster1x1_1ctamma
python benchmark/TBD/gemm/benchmark_matmul.py --timing nsys                # ground-truth, slower
python benchmark/TBD/gemm/benchmark_matmul.py --timing events              # plain wall-clock (includes ~50us/call Python overhead)
```
...
nsys profile -o report --stats=true --force-overwrite=true \
  python benchmark/TBD/gemm/benchmark_matmul.py --timing events --shape 4096,4096,4096 \
